...
function checknumber() {
  ...
  if (number % 2 == 0) {
    return (document.getElementById("ChNo").innerHTML =
...
function checknumber1() {
  ...
  if (number > 0) {
    return (document.getElementById("ChNo1").innerHTML =
      number + " its a Possitve Number");
  } else {
    document.getElementById("ChNo1").innerHTML =
      number + " its a Negative Number";
  }
}
...
function checknumber2() {
  ...
  if (age > 18) {
    return (document.getElementById("ChNo2").innerHTML =
      "You are eligible for casting vote ");
  } else {
    document.getElementById("ChNo2").innerHTML =
      "You not are eligible for casting vote ";
  }
}
...
function checknumber3() {
  ...
  if (heightmeter == 1) {
    document.getElementById("ChNo3").innerHTML =
      heightcentimeter + " Cm (Mediam Height) ";
  } else if (heightmeter == 2) {
    document.getElementById("ChNo3").innerHTML =
      heightcentimeter + " Cm (Tall) ";
  } else if (heightmeter > 2) {
    document.getElementById("ChNo3").innerHTML =
      heightcentimeter + " Cm (very tall) ";
  } else {
    document.getElementById("ChNo3").innerHTML =
      heightcentimeter + " Cm (Small) ";
  }
}
...
function checknumber4() {
  ...
  if (score >= 80 && score <= 100) {
    ...
    document.getElementById("ChNo4").innerHTML =
      "Please enter a score less then 100 ";
  }
}
